...
export interface AtlantisMethods {
...
export interface AtlantisScenarioMethods extends AtlantisMethods {
...
export interface Atlantis extends Contract {
  methods: AtlantisMethods;
  name: string;
}

export interface AtlantisScenario extends Contract {
  methods: AtlantisScenarioMethods;
  name: string;
}
