...
note: $MATICERSCAN_API_KEY environment variable must be set to an Etherscan API Key.
...
(async function() {
  ...
  let etherscanApiKey = env['MATICERSCAN_API_KEY'];
  if (!etherscanApiKey) {
    console.error("Missing required $MATICERSCAN_API_KEY env variable.");
    return printUsage();
  }
