...
describe("governorBravo#castVote/2", () => {
  let atlantis, gov, root, a1, accounts, govDelegate;
  ...
  beforeAll(async () => {
    ...
    gov = await deploy('GovernorBravoDelegator', [address(0), atlantis._address, root, govDelegate._address, 17280, 1, "100000000000000000000000"]);
