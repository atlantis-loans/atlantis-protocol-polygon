...
contract PriceOracleProxy is PriceOracle {
    ...
    /// @notice Address of the aMATIC contract, which has a constant price
     ...
     * @param aMATICAddress_ The address of aMATIC, which will return a constant 1e18, since all prices relative to ether
    ...
    function getUnderlyingPrice(AToken aToken) public view returns (uint) {
        ...
        if (aTokenAddress == aMATICAddress) {
